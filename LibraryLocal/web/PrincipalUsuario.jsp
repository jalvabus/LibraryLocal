...
<html ng-app="principalApp">
    ...
    <body data-spy="scroll" data-target="#navbar-example" ng-controller="principalController">
        ...
        <!-- Ir a Devolución Area -->
        <div ng-if="eventosHoy.length > 0" class="suscribe-area" style="background-color: #959595;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="suscribe-text text-center">
                            <h3>Tiene eventos programados para hoy.</h3>
                            <a class="sus-btn" href="#eventoCompra.total">Ver mis eventos</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="suscribe-area">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="suscribe-text text-center">
                            <h3>Devoluci&oacute;n de Libros por defecto o equivocaci&oacute;n</h3>
                            <a class="sus-btn" href="#devolucion">Ir</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="about-move">
                                <div class="services-details">
                                    <div class="single-services">
                                        ...
                                        <button ng-if="evento.cupo > 0" class="btn btn-secondary btn-lg btn-block" data-toggle="modal" data-target="#exampleModal" ng-click="boletosEvento(evento)">Comprar Evento</button>
                                        <button ng-if="evento.cupo === 0" class="btn btn-danger btn-lg btn-block" disabled>Boletos Agotados</button>
        ...
        <!-- Modal Comprar Boleto Evento -->
        <div class="modal" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="text-align: center; padding-top: 10%;">
            <div class="modal-dialog" role="document" style="display: inline-block; vertical-align: middle; text-align: left; height: 100%;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="sec-head">Comprar boletos para : {{ evento.nombre}}</h5>
                    ...
                    <div class="modal-body" style="margin: 20px;">
                        <div>
                            <div class="row">
                                <div clas="form-group">
                                    <h5 class="modal-title" id="">Cupo</h5>
                                ...
                                <div clas="form-group">
                                    ...
                                    <input disabled name="pass" id="" ng-model="evento.costo" type="number" placeholder="" class="form-control">
                                </div>
                                <div clas="form-group">
                                ...
                                <div clas="form-group">
                                    <h5 class="modal-title" id="">Cantidad Boletos</h5>
                                    <input name="correo" id="" ng-model="eventoCompra.boletos" ng-keydown="calcularBoletos()" ng-keyup="calcularBoletos()" ng-keypress="calcularBoletos()" type="number" placeholder="" class="form-control">
                                </div>
                                <div ng-if="boletosAlanza">
                                    <div clas="form-group">
                                        <h5 class="modal-title" id="">Total : </h5>
                                        <input disabled ng-model="eventoCompra.total" id="" type="number" placeholder="" class="form-control">
                                    </div>
                                    <div clas="form-group">
                                        <h5 class="modal-title" id="">Pagos : </h5>
                                        <select ng-model="eventoCompra.cantidadPagos" class="form-control">
                                            <option value="1">1</option>
                                            <option value="2">2</option>
                                        </select>
                                    </div>
                                    <div clas="form-group" ng-if="eventoCompra.cantidadPagos === '2'">
                                        <h5 class="modal-title" id="">Cantidad minima a Pagar : </h5>
                                        <input disabled name="correo" id="" ng-model="eventoCompra.pagoMinimo" value="{{eventoCompra.total / 2}}" type="number" placeholder="" class="form-control">
                                    </div>
                                    <div ng-if="eventoCompra.cantidadPagos === '1' || eventoCompra.cantidadPagos === '2'">
                                        <div class="row col-xs-12" style="margin-top: 20px;">
                                            <div class="col-xs-12">
                                                <h4>Datos de compra</h4>
                                                <form class="contactForm">
                                                    <label>Seleccione tipo de pago</label>
                                                    <select ng-model="tipopago" ng-change="getSaldoTarjeta()" id="tipopago" class="form-control">
                                                    ...
                                                    <div class="form-group" style="margin-top: 20px;" ng-if="tipopago">
                                                        ...
                                                        <input type="text" class="form-control" ng-model="tarjeta" id="saldoTarjeta" placeholder="Numero de tarjeta">
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="ready-btn page-scroll" ng-if="verificacionTarjeta" ng-click="comprarBoletos()">Comprar Boletos</button>
                        <button type="button" class="ready-btn page-scroll" data-dismiss="modal">Cancelar</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Mis los eventos area -->
        <div id="miseventos" class="about-area area-padding">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="section-headline services-head text-center">
                ...
                <div class="row text-center">
                    <div class="services-contents">
                        <!-- Start Left services -->
                        <div class="col-md-4 col-sm-4 col-xs-12" ng-repeat="evento in miseventos">
                            <div class="about-move">
                                <div class="services-details">
                                    <div class="single-services">
                                        <img src="img/events/{{ evento.foto}}">
                                        ...
                                        <button class="btn btn-secondary btn-lg btn-block" data-toggle="modal" data-target="#modalCancelarEvento" ng-click="cancelarBoletosEvento(evento)">Cancelar Compra</button>
                                    </div>
                                </div>
                                <!-- end about-details -->
                            </div>
